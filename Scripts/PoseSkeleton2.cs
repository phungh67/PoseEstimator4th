...
public class PoseSkeleton2
{
    ...
    public PoseSkeleton2(float pointScale = 10f, float lineWidth = 5f)
    {
        ...
        for (int i = 0; i < NUM_KEYPOINTS; i++)
        {
            ...
            this.keypoints[i].position = new Vector3(1080/2, 1920/2, 0);
    ...
    public void UpdateKeyPointPositions(Utils2.Keypoint[] keypoints,
